...
\end{equation}
\item Jetzt sei $\xi$ derart, dass für ein $\psi\in \mathcal{C}^\infty_c(\RR^n)$ gilt $\xi=\nabla\psi$. Es gilt (Taylor):
\begin{equation}
